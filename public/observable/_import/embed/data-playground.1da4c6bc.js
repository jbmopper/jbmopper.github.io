...
const ATTACHMENTS = {
  "traces/bad_head_size_nsys.parquet": FileAttachment({"name":"../../data/raw/traces/bad_head_size_nsys.parquet","mimeType":undefined,"path":"../../_file/data/raw/traces/bad_head_size_nsys.0e5fcf94.parquet","lastModified":1771465633642,"size":699507}, import.meta.url),
  "traces/bandwidth_bound_nsys.parquet": FileAttachment({"name":"../../data/raw/traces/bandwidth_bound_nsys.parquet","mimeType":undefined,"path":"../../_file/data/raw/traces/bandwidth_bound_nsys.0570a4e8.parquet","lastModified":1771465633645,"size":526034}, import.meta.url),
  ...
  "traces/misaligned_dims_nsys.parquet": FileAttachment({"name":"../../data/raw/traces/misaligned_dims_nsys.parquet","mimeType":undefined,"path":"../../_file/data/raw/traces/misaligned_dims_nsys.accc5b6e.parquet","lastModified":1771874136944,"size":669386}, import.meta.url),
  ...
  "traces/wide_ffn_nsys.parquet": FileAttachment({"name":"../../data/raw/traces/wide_ffn_nsys.parquet","mimeType":undefined,"path":"../../_file/data/raw/traces/wide_ffn_nsys.e3df5806.parquet","lastModified":1771465633667,"size":715444}, import.meta.url),
  "traces/nsys_sqlite_table_inventory.md": FileAttachment({"name":"../../data/raw/traces/nsys_sqlite_table_inventory.md","mimeType":"text/markdown","path":"../../_file/data/raw/traces/nsys_sqlite_table_inventory.8a62282f.md","lastModified":1771465633668,"size":25493}, import.meta.url),
  "benchmarks/ablations_main.parquet": FileAttachment({"name":"../../data/raw/benchmarks/ablations_main.parquet","mimeType":undefined,"path":"../../_file/data/raw/benchmarks/ablations_main.912ec8a5.parquet","lastModified":1771874136911,"size":26405}, import.meta.url),
  "benchmarks/ablations_history.parquet": FileAttachment({"name":"../../data/raw/benchmarks/ablations_history.parquet","mimeType":undefined,"path":"../../_file/data/raw/benchmarks/ablations_history.c15e6588.parquet","lastModified":1771874136910,"size":2777049}, import.meta.url),
  "benchmarks/gpu_comp_main.parquet": FileAttachment({"name":"../../data/raw/benchmarks/gpu_comp_main.parquet","mimeType":undefined,"path":"../../_file/data/raw/benchmarks/gpu_comp_main.d82fa693.parquet","lastModified":1771874136918,"size":21863}, import.meta.url),
  "benchmarks/gpu_comp_history.parquet": FileAttachment({"name":"../../data/raw/benchmarks/gpu_comp_history.parquet","mimeType":undefined,"path":"../../_file/data/raw/benchmarks/gpu_comp_history.e18efbee.parquet","lastModified":1771874136917,"size":1389327}, import.meta.url),
  "benchmarks/mps_comp_main.parquet": FileAttachment({"name":"../../data/raw/benchmarks/mps_comp_main.parquet","mimeType":undefined,"path":"../../_file/data/raw/benchmarks/mps_comp_main.f7579557.parquet","lastModified":1771874136937,"size":21062}, import.meta.url),
  "benchmarks/mps_comp_history.parquet": FileAttachment({"name":"../../data/raw/benchmarks/mps_comp_history.parquet","mimeType":undefined,"path":"../../_file/data/raw/benchmarks/mps_comp_history.8ee202e9.parquet","lastModified":1771874136937,"size":1535334}, import.meta.url),
  "benchmarks/lr_sweeps_main.parquet": FileAttachment({"name":"../../data/raw/benchmarks/lr_sweeps_main.parquet","mimeType":undefined,"path":"../../_file/data/raw/benchmarks/lr_sweeps_main.98e6db0c.parquet","lastModified":1771874136930,"size":15015}, import.meta.url),
  "benchmarks/lr_sweeps_history.parquet": FileAttachment({"name":"../../data/raw/benchmarks/lr_sweeps_history.parquet","mimeType":undefined,"path":"../../_file/data/raw/benchmarks/lr_sweeps_history.4f809053.parquet","lastModified":1771874136930,"size":3312658}, import.meta.url),
  "benchmarks/micro_benchmarks_20260126_130256.json": FileAttachment(
    {"name":"../../data/raw/benchmarks/micro_benchmarks_20260126_130256.json","mimeType":"application/json","path":"../../_file/data/raw/benchmarks/micro_benchmarks_20260126_130256.0003d6fe.json","lastModified":1771465633680,"size":2403}, import.meta.url
  ),
  "benchmarks/train_benchmark_20260127_092323.json": FileAttachment(
    {"name":"../../data/raw/benchmarks/train_benchmark_20260127_092323.json","mimeType":"application/json","path":"../../_file/data/raw/benchmarks/train_benchmark_20260127_092323.e80aa474.json","lastModified":1771465633684,"size":1945563}, import.meta.url
  )
};
...
const DATASET_CACHE_IDLE_MS = 2 * 60 * 1000;
let datasetCacheTimer = null;

function touchDatasetCache() {
  if (typeof window === "undefined") return;
  if (datasetCacheTimer) window.clearTimeout(datasetCacheTimer);
  datasetCacheTimer = window.setTimeout(() => {
    datasetCatalogPromise = null;
    datasetCache.clear();
    datasetCacheTimer = null;
  }, DATASET_CACHE_IDLE_MS);
}

function touchDatasetEntry(cacheKey) {
  if (!datasetCache.has(cacheKey)) return;
  const value = datasetCache.get(cacheKey);
  datasetCache.delete(cacheKey);
  datasetCache.set(cacheKey, value);
}

function setDatasetCacheEntry(cacheKey, value) {
  if (datasetCache.has(cacheKey)) datasetCache.delete(cacheKey);
  datasetCache.set(cacheKey, value);
...
async function loadDataset(datasetById, datasetId, sampleLimit) {
  ...
  promise.catch(() => {
    if (datasetCache.get(cacheKey) === promise) datasetCache.delete(cacheKey);
  });
...
export const renderDataPlayground = resilientRender("renderDataPlayground", async function renderDataPlayground(options = {}) {
  ...
  // Switching datasets while one is still loading must not let the slower,
  // older load overwrite the newer one.
  let refreshSeq = 0;
