...
const EMPIRICAL_CACHE_IDLE_MS = 2 * 60 * 1000;
let empiricalCacheTimer = null;

function touchEmpiricalCache() {
  if (typeof window === "undefined") return;
  if (empiricalCacheTimer) window.clearTimeout(empiricalCacheTimer);
  empiricalCacheTimer = window.setTimeout(() => {
    empiricalDataPromise = null;
    empiricalCacheTimer = null;
  }, EMPIRICAL_CACHE_IDLE_MS);
}
