    ...
    redeployment = sha1(
      jsonencode(
        compact([
          ...
          aws_api_gateway_resource.turnstile_verify.id,
          aws_api_gateway_method.turnstile_post.id,
          aws_api_gateway_method.options_turnstile.id,
          ...
          aws_api_gateway_resource.resume_generate.id,
          try(aws_api_gateway_resource.resume_job[0].id, ""),
          try(aws_api_gateway_resource.resume_job_id[0].id, ""),
          try(aws_api_gateway_method.resume_post[0].id, ""),
          try(aws_api_gateway_method.options_resume[0].id, ""),
          try(aws_api_gateway_method.resume_job_get[0].id, ""),
          try(aws_api_gateway_method.options_resume_job[0].id, ""),
